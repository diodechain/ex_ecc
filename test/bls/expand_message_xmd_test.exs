defmodule ExEcc.BLS.ExpandMessageXMDTest do
  use ExUnit.Case
  ...
  test "expand_message_xmd sha256" do
    test_cases = [
      {
        "",
        0x20,
    ...
    for {msg, len_in_bytes, expected_hex} <- test_cases do
      result = Hash.expand_message_xmd(msg, @dst, len_in_bytes, Hash.sha256_function())
      expected = Base.decode16!(expected_hex, case: :lower)
