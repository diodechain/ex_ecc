defmodule ExEcc.OptimizedBls12381.Constants do
  ...
  @etas [
    FQ2.new([@ev1, @ev2]),
    FQ2.new([FQ2.neg(@ev2), @ev1]),
    FQ2.new([@ev3, @ev4]),
    FQ2.new([FQ2.neg(@ev4), @ev3])
  ]
  ...
  # from https://datatracker.ietf.org/doc/html/draft-irtf-cfrg-hash-to-curve-09#section-8.8.2
  ...
  # G1
  # Ensure FQ.field_modulus() is available and returns an integer for bitwise operations
  # @p_minus_3_div_4 (FQ.field_modulus() - 3) <<< 2 # Elixir uses div for integer division
  @p_minus_3_div_4 div(FQ.field_modulus() - 3, 4)
  @sqrt_minus_11_cubed FQ.new(
  ...
  @iso_11_y_numerator [
    ...
    FQ.new(
      0x17429E8B3D873F0F3B58ADDFB85677288A2593A0E28547248A41886735C40803CB6AD4F3D3430FEF90498E91C373635A
    )
  ]
  @iso_11_y_denominator [
    FQ.new(
      0x4BFDF47A4F9807497F22958D5B8D518431A39E5B5419A0370DE8F6350E100B928C38430938D6B139C3B4E7E84068944
    ),
    FQ.new(
      0x4E046259502419726983863756E0E10EC2036CB1FF85528530C72CCF18DFB901B0E8D9441F0D7C8CFE63F185F40C82F
    ),
    FQ.new(
      0x154D510C58AF1C1599D0D62F20678EE8782F7F21235B7CD40B12938DDD58EBEEB2BC291F2B8A8BB857B51F507714C6B9
    ),
    FQ.new(
      0x11569690F1471B217D0F973B70496BB2E42935368E25A04897556728D75379575093D329B8093A608D2C60DE1F0217E2
    ),
    FQ.new(
      0x61A6068A606789DCA5696873F4266C1A33900A728649F4A5E7C0E799FF89E17AD7F9B4904D6442B05BF75E1642B715F
    ),
    FQ.new(
      0x108561919014237619484956441337263F6561D8D49899477BEE163390E00D9360D1D4932059E831F034840519D6E342
    ),
    FQ.new(
      0x4CAE13BD7226199237D3C6A361D1F94F2964E8975B3304B96F082A82C173B3A9ADF3E03B71D5916357350359F0BD715
    ),
    FQ.new(
      0xE4751AA93C79E58232776F9E698F5D0A04C6E640DD7DA47FC54FB3647527090B842B1556F942D0BD1D1055EB456785C
    ),
    FQ.new(
      0xCFB00E3E769D80E93B465F78A6108D5A1CE252807D033B05BC382D79A704E92616776768E3A176720E23F9E393F06E9
    ),
    FQ.new(
      0xB5206F65D50A5740823A5049EA8E24CE7368D51F80B1F2E49A116F18DF9A164E6B0BF7D07EF9789A209597502703B1D
    ),
    FQ.new(
      0x558691E09F59F6F60D0C5CE645B0F39DFEB3E2DD24B80CDA5E829F4F02E73F60C289546BD4679F44B3271735E40C719
    ),
    FQ.new(
      0x50A50427038036D1E536E59282290E420485988E9A93F0F89CC86D6AB196773936227179500732376274438A80E721A
    ),
    FQ.new(1)
  ]
  ...
  # Optimized BLS12_381 G1 parameters
  @param_z FQ.new(11)
  @eff_a FQ.new(0)
  @eff_b FQ.new(1324)
  @beta FQ.new(
          0xCD03C6C1438F279850A7A9A3834415D20F5B848FD5846787B13A8A513838A4414B005881A42EBC351640FF4A7A7A8239
        )
  @alpha FQ.new(
           0x3F26210F833F6B2847A37018809DC8348907254CB512CF481984137A2049929030ED8A38CD8B8A047A0A64A822219CE7
         )
  @lambda_ FQ.new(
             0x290F83BB68DE0CAD5183714B1623B0D051444AF16E595B69104C4D94F977A5BFDB4084A4FFA0ED894F7A09C01699D175
           )

  # H_EFF_G1 was missing
  ...
  def iso_11_x_numerator, do: @iso_11_x_numerator
  def iso_11_x_denominator, do: @iso_11_x_denominator
  def iso_11_y_numerator, do: @iso_11_y_numerator
  def iso_11_y_denominator, do: @iso_11_y_denominator
  def iso_11_map_coefficients, do: @iso_11_map_coefficients
  def param_z, do: @param_z
  def eff_a, do: @eff_a
  def eff_b, do: @eff_b
  def beta, do: @beta
  def alpha, do: @alpha
  def lambda, do: @lambda_
